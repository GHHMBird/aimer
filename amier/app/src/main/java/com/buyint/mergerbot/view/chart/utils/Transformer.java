...
package com.buyint.mergerbot.view.chart.utils;
...
import com.buyint.mergerbot.view.chart.data.CandleEntry;
...
public class Transformer {
    ...
    public float[] generateTransformedValuesBubble(IBubbleDataSet data,
        ...
        final int count = (int) Math.ceil(to - from) * 2; // (ints) Math.ceil((to - from) * phaseX) * 2;
