package com.buyint.mergerbot.view.chart.highlight;
...
public class ChartHighlighter<T extends BarLineScatterCandleBubbleDataProvider> {
	 ...
	 * @return
	 */
	public com.buyint.mergerbot.view.chart.highlight.Highlight getHighlight(float x, float y) {
		...
		return new com.buyint.mergerbot.view.chart.highlight.Highlight(xIndex,
