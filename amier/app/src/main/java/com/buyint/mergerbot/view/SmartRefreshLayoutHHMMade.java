 ...
 *  srlEnablePureScrollModeTop srlEnablePureScrollModeBottom
 * modified by hhm on 2018/5/26. 相比原有布局，将纯滚动模式分开，分为下拉纯滚动和加载更多纯滚动
 */
@SuppressLint("RestrictedApi")
@SuppressWarnings({"unused", "WeakerAccess"})
public class SmartRefreshLayoutHHMMade extends ViewGroup implements RefreshLayout, NestedScrollingParent/*, NestedScrollingChild*/ {
    ...
    protected boolean mEnablePureScrollModeTop = false;//是否上半部分纯滚动
    protected boolean mEnablePureScrollModeBottom = false;//是否下半部分纯滚动
    ...
    public SmartRefreshLayoutHHMMade(Context context) {
        this(context, null);
    }

    public SmartRefreshLayoutHHMMade(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SmartRefreshLayoutHHMMade(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.SmartRefreshLayout);

        mNestedChild.setNestedScrollingEnabled(ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableNestedScrolling, mNestedChild.isNestedScrollingEnabled()));
        ...
        mHeaderHeight = ta.getDimensionPixelOffset(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlHeaderHeight, mHeaderHeight);
        mFooterHeight = ta.getDimensionPixelOffset(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFooterHeight, mFooterHeight);
        mHeaderInsetStart = ta.getDimensionPixelOffset(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlHeaderInsetStart, mHeaderInsetStart);
        mFooterInsetStart = ta.getDimensionPixelOffset(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFooterInsetStart, mFooterInsetStart);
        ...
        mEnablePureScrollModeTop = t.getBoolean(R.styleable.SmartRefreshLayout_srlEnablePureScrollModeTop, mEnablePureScrollModeTop);
        mEnablePureScrollModeBottom = t.getBoolean(R.styleable.SmartRefreshLayout_srlEnablePureScrollModeBottom, mEnablePureScrollModeBottom);
        ...
        mEnableClipHeaderWhenFixedBehind = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableClipHeaderWhenFixedBehind, mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta.getBoolean(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableClipFooterWhenFixedBehind, mEnableClipFooterWhenFixedBehind);
        ...
        mFixedHeaderViewId = ta.getResourceId(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFixedHeaderViewId, mFixedHeaderViewId);
        mFixedFooterViewId = ta.getResourceId(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFixedFooterViewId, mFixedFooterViewId);
        mHeaderTranslationViewId = ta.getResourceId(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlHeaderTranslationViewId, mHeaderTranslationViewId);
        mFooterTranslationViewId = ta.getResourceId(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlFooterTranslationViewId, mFooterTranslationViewId);

        if ((mEnablePureScrollModeTop || mEnablePureScrollModeBottom) && !ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableOverScrollDrag)) {
            mEnableOverScrollDrag = true;
        }

        mManualLoadMore = mManualLoadMore || ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableLoadMore);
        mManualHeaderTranslationContent = mManualHeaderTranslationContent || ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableHeaderTranslationContent);
        mManualFooterTranslationContent = mManualFooterTranslationContent || ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableFooterTranslationContent);
        mManualNestedScrolling = mManualNestedScrolling || ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.SmartRefreshLayout_srlEnableNestedScrolling);
    ...
    protected void onAttachedToWindow() {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshContent == null) {
                ...
                errorView.setText(com.scwang.smartrefresh.layout.R.string.srl_content_empty);
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = SmartRefreshLayoutHHMMade.this;
                        for (ViewParent parent = thisView.getParent(); parent != null; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = SmartRefreshLayoutHHMMade.this;
        ...
        for (int i = 0, len = super.getChildCount(); i < len; i++) {
            ...
            if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
                ...
                if (mRefreshHeader.getSpinnerStyle() == SpinnerStyle.MatchLayout) {
                    ...
                    height = Math.max(0, isEnableRefresh(mEnableRefresh) ? mSpinner : 0);
                }
                ...
                if (needPreview && isEnableRefresh(mEnableRefresh)) {
            ...
            if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                ...
                if (mRefreshFooter.getSpinnerStyle() == SpinnerStyle.MatchLayout) {
                    ...
                    height = Math.max(0, isEnableLoadMore(mEnableLoadMore) ? -mSpinner : 0);
                }
                ...
                if (needPreview && isEnableLoadMore(mEnableLoadMore)) {
            ...
            if (mRefreshContent != null && mRefreshContent.getView() == child) {
                ...
                final boolean showHeader = (mRefreshHeader != null && isEnableRefresh(mEnableRefresh) && isEnableTranslationContent(mEnableHeaderTranslationContent, mRefreshHeader));
                final boolean showFooter = (mRefreshFooter != null && isEnableLoadMore(mEnableLoadMore) && isEnableTranslationContent(mEnableFooterTranslationContent, mRefreshFooter));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0, len = super.getChildCount(); i < len; i++) {
            ...
            if (mRefreshContent != null && mRefreshContent.getView() == child) {
                boolean isPreviewMode = thisView.isInEditMode() && mEnablePreviewInEditMode && isEnableRefresh(mEnableRefresh) && mRefreshHeader != null;
                final View contentView = mRefreshContent.getView();
                final LayoutParams lp = (LayoutParams) contentView.getLayoutParams();
            ...
            if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
                boolean isPreviewMode = thisView.isInEditMode() && mEnablePreviewInEditMode && isEnableRefresh(mEnableRefresh);
                final View headerView = mRefreshHeader.getView();
                final LayoutParams lp = (LayoutParams) headerView.getLayoutParams();
...
//                        bottom = top + Math.max(Math.max(0, isEnableRefreshOrLoadMore(mEnableRefresh) ? mSpinner : 0) - lp.bottomMargin - lp.topMargin, 0);
            ...
            if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                final boolean isPreviewMode = thisView.isInEditMode() && mEnablePreviewInEditMode && isEnableLoadMore(mEnableLoadMore);
                final View footerView = mRefreshFooter.getView();
                final LayoutParams lp = (LayoutParams) footerView.getLayoutParams();
                ...
                if (style == SpinnerStyle.MatchLayout) {
                    ...
                    top = top - Math.max(isEnableLoadMore(mEnableLoadMore) ? -mSpinner : 0, 0);
                }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
            if (!isEnableRefresh(mEnableRefresh) || (!mEnablePreviewInEditMode && thisView.isInEditMode())) {
                return true;
            }
            if (contentView != null) {
        ...
        if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
            if (!isEnableLoadMore(mEnableLoadMore) || (!mEnablePreviewInEditMode && thisView.isInEditMode())) {
                return true;
            }
            if (contentView != null) {
    ...
    public void computeScroll() {
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            if ((finalY < 0 && (mEnableOverScrollDrag || isEnableRefresh(mEnableRefresh)) && mRefreshContent.canRefresh())
                    || (finalY > 0 && (mEnableOverScrollDrag || isEnableLoadMore(mEnableLoadMore)) && mRefreshContent.canLoadMore())) {
                if (mVerticalPermit) {
                    float velocity;
        ...
        if (mNestedInProgress) {//嵌套滚动时，补充竖直方向不滚动，但是水平方向滚动，需要通知 onHorizontalDrag
            ...
            if (action == MotionEvent.ACTION_MOVE) {
                if (totalUnconsumed == mTotalUnconsumed) {
                    ...
                    if (isEnableRefresh(mEnableRefresh) && mSpinner > 0 && mRefreshHeader != null && mRefreshHeader.isSupportHorizontalDrag()) {
                        mRefreshHeader.onHorizontalDrag(percentX, offsetX, offsetMax);
                    } else if (isEnableLoadMore(mEnableLoadMore) && mSpinner < 0 && mRefreshFooter != null && mRefreshFooter.isSupportHorizontalDrag()) {
            ...
            return ret;
                ...
                || (!isEnableRefresh(mEnableRefresh) && !isEnableLoadMore(mEnableLoadMore) && !mEnableOverScrollDrag)
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!mIsBeingDragged && mDragDirection != 'h' && mRefreshContent != null) {//没有拖动之前，检测  canRefresh canLoadMore 来开启拖动
                    if (mDragDirection == 'v' || (Math.abs(dy) >= mTouchSlop && Math.abs(dx) < Math.abs(dy))) {//滑动允许最大角度为45度
                        mDragDirection = 'v';
                        if (dy > 0 && (mSpinner < 0 || ((mEnableOverScrollDrag || isEnableRefresh(mEnableRefresh)) && mRefreshContent.canRefresh()))) {
                            mIsBeingDragged = true;
                            mTouchY = touchY - mTouchSlop;//调整 mTouchSlop 偏差
                        } else if (dy < 0 && (mSpinner > 0 || ((mEnableOverScrollDrag || isEnableLoadMore(mEnableLoadMore)) && ((mState == RefreshState.Loading && mFooterLocked) || mRefreshContent.canLoadMore())))) {
                            mIsBeingDragged = true;
                            mTouchY = touchY + mTouchSlop;//调整 mTouchSlop 偏差
                        }
                        if (mIsBeingDragged) {
                ...
                if (mIsBeingDragged) {
                    ...
                    if ((mViceState.isHeader && (spinner < 0 || mLastSpinner < 0)) || (mViceState.isFooter && (spinner > 0 || mLastSpinner > 0))) {
                        ...
                        if (spinner > 0 && ((mEnableOverScrollDrag || isEnableRefresh(mEnableRefresh)) && mRefreshContent.canRefresh())) {
                            mTouchY = mLastTouchY = touchY;
                            mTouchSpinner = spinner = 0;
                            mKernel.setState(RefreshState.PullDownToRefresh);
                        } else if (spinner < 0 && ((mEnableOverScrollDrag || isEnableLoadMore(mEnableLoadMore)) && mRefreshContent.canLoadMore())) {
                            mTouchY = mLastTouchY = touchY;
                            mTouchSpinner = spinner = 0;
                            mKernel.setState(RefreshState.PullUpToLoad);
                        }
    ...
    protected boolean startFlingIfNeed(Float flingVelocity) {
        ...
        if (Math.abs(velocity) > mMinimumVelocity) {
            ...
            if ((velocity < 0 && ((mEnableOverScrollBounce && (mEnableOverScrollDrag || isEnableLoadMore(mEnableLoadMore))) || (mState == RefreshState.Loading && mSpinner >= 0) || (mEnableAutoLoadMore && isEnableLoadMore(mEnableLoadMore))))
                    || (velocity > 0 && ((mEnableOverScrollBounce && (mEnableOverScrollDrag || isEnableRefresh(mEnableRefresh))) || (mState == RefreshState.Refreshing && mSpinner <= 0)))) {
...
//            }
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(SmartRefreshLayoutHHMMade.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(SmartRefreshLayoutHHMMade.this, mHeaderHeight, (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(SmartRefreshLayoutHHMMade.this);
    ...
    protected boolean isEnableTranslationContent(boolean enable, RefreshInternal internal) {
        return enable || (mEnablePureScrollModeTop && mEnablePureScrollModeBottom) || internal == null || internal.getSpinnerStyle() == SpinnerStyle.FixedBehind;
    }

    protected boolean isEnableLoadMore(boolean enable) {
        return enable && !mEnablePureScrollModeBottom;
    }

    protected boolean isEnableRefresh(boolean enable) {
        return enable && !mEnablePureScrollModeTop;
    }
    ...
    protected class FlingRunnable implements Runnable {
        ...
        public Runnable start() {
            ...
            if (mSpinner != 0 && (!(mState.isOpening || (mFooterNoMoreData && mEnableFooterFollowWhenLoadFinished && isEnableLoadMore(mEnableLoadMore)))
                    || ((mState == RefreshState.Loading || (mFooterNoMoreData && mEnableFooterFollowWhenLoadFinished && isEnableLoadMore(mEnableLoadMore))) && mSpinner < -mFooterHeight)
...
//            reboundAnimator.setDuration(20000);
        ...
        if (reboundAnimator == null) {
            if (velocity > 0 && (mState == RefreshState.Refreshing || mState == RefreshState.TwoLevel)) {
                animationRunnable = new BounceRunnable(velocity, mHeaderHeight);
                    ...
                    || (mEnableFooterFollowWhenLoadFinished && mFooterNoMoreData && isEnableLoadMore(mEnableLoadMore))
                    || (mEnableAutoLoadMore && !mFooterNoMoreData && isEnableLoadMore(mEnableLoadMore) && mState != RefreshState.Refreshing))) {
    ...
    protected void overSpinner() {
        if (mState == RefreshState.TwoLevel) {
            ...
            if (mCurrentVelocity > -1000 && mSpinner > thisView.getMeasuredHeight() / 2) {
                ...
                || (mEnableFooterFollowWhenLoadFinished && mFooterNoMoreData && mSpinner < 0 && isEnableLoadMore(mEnableLoadMore))) {
    ...
    protected void moveSpinnerInfinitely(float spinner) {
        ...
        if (mState == RefreshState.TwoLevel && spinner > 0) {
            ...
            if (spinner < mHeaderHeight) {
                ...
                || (mEnableFooterFollowWhenLoadFinished && mFooterNoMoreData && isEnableLoadMore(mEnableLoadMore))
                || (mEnableAutoLoadMore && !mFooterNoMoreData && isEnableLoadMore(mEnableLoadMore)))) {
        ...
        if (mEnableAutoLoadMore && !mFooterNoMoreData && isEnableLoadMore(mEnableLoadMore) && spinner < 0
    ...
    public boolean onStartNestedScroll(@NonNull View child, @NonNull View target, int nestedScrollAxes) {
        ...
        accepted = accepted && (mEnableOverScrollDrag || isEnableRefresh(mEnableRefresh) || isEnableLoadMore(mEnableLoadMore));
        return accepted;
    }
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        ...
        if (dy != 0 && (mEnableOverScrollDrag || (dy < 0 && isEnableRefresh(mEnableRefresh)) || (dy > 0 && isEnableLoadMore(mEnableLoadMore)))) {
...
//    }
    ...
    @Override
    public SmartRefreshLayoutHHMMade setFooterHeight(float heightDp) {
    ...
    @Override
    public SmartRefreshLayoutHHMMade setHeaderHeight(float heightDp) {
    ...
    @Override
    public SmartRefreshLayoutHHMMade setHeaderInsetStart(float insetDp) {
        mHeaderInsetStart = dp2px(insetDp);
        return this;
    }

    @Override
    public SmartRefreshLayoutHHMMade setFooterInsetStart(float insetDp) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setReboundDuration(int duration) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnablePureScrollMode(boolean enabled) {
        return this;
    }
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade getLayout() {
        return this;
    }
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishRefresh() {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishRefresh(int delayed) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishRefresh(int delayed, final boolean success) {
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(SmartRefreshLayoutHHMMade.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            SmartRefreshLayoutHHMMade.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + mSpinner - mTouchSlop * 2, 0));
                            SmartRefreshLayoutHHMMade.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + mSpinner, 0));
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishLoadMore(int delayed) {
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(SmartRefreshLayoutHHMMade.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged || mNestedInProgress) {
                            ...
                            SmartRefreshLayoutHHMMade.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mLastTouchY + offset + mTouchSlop * 2, 0));
                            SmartRefreshLayoutHHMMade.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mLastTouchY + offset, 0));
                            if (mNestedInProgress) {
                                mTotalUnconsumed = 0;
                            }
                        }
     ...
     */
    @Override
    public SmartRefreshLayoutHHMMade finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
    ...
    public boolean autoRefresh(int delayed, final int duration, final float dragRate) {
        if (mState == RefreshState.None && isEnableRefresh(mEnableRefresh)) {
            if (reboundAnimator != null) {
                reboundAnimator.cancel();
            }
    ...
    public boolean autoLoadMore(int delayed, final int duration, final float dragRate) {
        if (mState == RefreshState.None && (isEnableLoadMore(mEnableLoadMore) && !mFooterNoMoreData)) {
            if (reboundAnimator != null) {
                reboundAnimator.cancel();
            }
            Runnable runnable = new Runnable() {
...
//    }
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshLayout getRefreshLayout() {
            return SmartRefreshLayoutHHMMade.this;
        }
        ...
        public RefreshKernel setState(@NonNull RefreshState state) {
            switch (state) {
                ...
                case PullDownToRefresh:
                    if (!mState.isOpening && isEnableRefresh(mEnableRefresh)) {
                    ...
                    break;
                case PullUpToLoad:
                    if (isEnableLoadMore(mEnableLoadMore) && !mState.isOpening && !mState.isFinishing && !(mFooterNoMoreData && mEnableFooterFollowWhenLoadFinished)) {
                ...
                case PullDownCanceled:
                    ...
                    break;
                case PullUpCanceled:
                    if (isEnableLoadMore(mEnableLoadMore) && !mState.isOpening && !(mFooterNoMoreData && mEnableFooterFollowWhenLoadFinished)) {
                ...
                case LoadReleased: {
                    if (!mState.isOpening && isEnableLoadMore(mEnableLoadMore)) {
                        notifyStateChanged(RefreshState.LoadReleased);
                    } else {
        ...
        public RefreshKernel moveSpinner(int spinner, boolean isDragging) {
            ...
            if ((spinner >= 0 || oldSpinner > 0) && mRefreshHeader != null) {
                ...
                if (isEnableRefresh(mEnableRefresh) || (mState == RefreshState.RefreshFinish && !isDragging)) {
            ...
            if ((spinner <= 0 || oldSpinner < 0) && mRefreshFooter != null) {
                ...
                if (isEnableLoadMore(mEnableLoadMore) || (mState == RefreshState.LoadFinish && !isDragging)) {
                    if (oldSpinner != mSpinner) {
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return SmartRefreshLayoutHHMMade.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
