...
public class CandleDataSet extends LineScatterCandleRadarDataSet<CandleEntry>
        implements com.buyint.mergerbot.view.chart.interfaces.datasets.ICandleDataSet {
     ...
     */
    protected int mNeutralColor = com.buyint.mergerbot.view.chart.utils.ColorTemplate.COLOR_NONE;

    /**
     * color for open < close
     */
    protected int mIncreasingColor = com.buyint.mergerbot.view.chart.utils.ColorTemplate.COLOR_NONE;

    /**
     * color for open > close
     */
    protected int mDecreasingColor = com.buyint.mergerbot.view.chart.utils.ColorTemplate.COLOR_NONE;

    /**
     * shadow line color, set -1 for backward compatibility and uses default
     * color
     */
    protected int mShadowColor = com.buyint.mergerbot.view.chart.utils.ColorTemplate.COLOR_NONE;
    ...
    @Override
    public DataSet<com.buyint.mergerbot.view.chart.data.CandleEntry> copy() {

        List<com.buyint.mergerbot.view.chart.data.CandleEntry> yVals = new ArrayList<CandleEntry>();

        for (int i = 0; i < mYVals.size(); i++) {
            yVals.add(((com.buyint.mergerbot.view.chart.data.CandleEntry) mYVals.get(i)).copy());
        }
    ...
    public void calcMinMax(int start, int end) {
        ...
        for (int i = start; i <= endValue; i++) {
            ...
            com.buyint.mergerbot.view.chart.data.CandleEntry e = mYVals.get(i);
    ...
    public void setShadowWidth(float width) {
        mShadowWidth = com.buyint.mergerbot.view.chart.utils.Utils.convertDpToPixel(width);
    }
