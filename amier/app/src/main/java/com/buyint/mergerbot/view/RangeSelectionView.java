...
public class RangeSelectionView extends View {
    ...
    private void init() {  
        ...
        paintBackground.setColor(getResources().getColor(R.color.colorBlack));
        ...
        paintText = new Paint();  
        paintText.setColor(Color.parseColor("#338500"));
        paintText.setTextSize(textSize);  
        paintText.setAntiAlias(true);  
  
        paintConnectLine = new Paint();  
        paintConnectLine.setColor(Color.parseColor("#ff0000"));
