package com.buyint.mergerbot.view.sweetsheet.sweetpick;
...
import com.buyint.mergerbot.view.sweetsheet.adapter.MenuRVAdapter;
import com.buyint.mergerbot.view.sweetsheet.entity.MenuEntity;
import com.buyint.mergerbot.view.sweetsheet.widget.FreeGrowUpParentRelativeLayout;
import com.buyint.mergerbot.view.sweetsheet.widget.SweetView;
...
//    private CRImageView sliderIm;
    ...
    public RecyclerViewDelegate(boolean dragEnable,int height) {
        mIsDragEnable=dragEnable;
        this.height = height;

    }

    public RecyclerViewDelegate(boolean dragEnable  ,int contentViewHeight,int height) {
    ...
    protected View createView() {
        ...
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mSweetView.getLayoutParams();
        params.height = height;
        // params.setMargins(dip2px(MainActivity.this, 1), 0, 0, 0); // 可以实现设置位置信息，如居左距离，其它类推
        // params.leftMargin = dip2px(MainActivity.this, 1);
        mSweetView.setLayoutParams(params);
