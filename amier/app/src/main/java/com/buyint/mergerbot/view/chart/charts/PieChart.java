...
import com.buyint.mergerbot.view.chart.interfaces.datasets.IPieDataSet;
import com.buyint.mergerbot.view.chart.renderer.PieChartRenderer;
 ...
 */
public class PieChart extends com.buyint.mergerbot.view.chart.charts.PieRadarChartBase<PieData> {
    ...
    /**
     * if true, the cicle_f4f5f7 hole inside the chart will be drawn
     */
...
//        mLegendRenderer.renderLegend(canvas);
    ...
    public void calculateOffsets() {
        ...
        float radius = diameter / 2f - 20;// 减去二十  可以避免文字被遮挡
