...
package com.buyint.mergerbot.view.chart.animation;
...
public class Easing {
    ...
    public static com.buyint.mergerbot.view.chart.animation.EasingFunction getEasingFunctionFromOption(EasingOption easing) {
        switch (easing) {
            default:
            case Linear:
    ...
    private static class EasingFunctions {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction Linear = new EasingFunction() {
            // @Override
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInQuad = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutQuad = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float position = elapsed / (float) duration;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutQuad = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInCubic = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float position = elapsed / (float) duration;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutCubic = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // float position = elapsed / (float) duration;
                    // position--;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutCubic = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // float position = elapsed / (duration / 2.f);
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInQuart = new EasingFunction() {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutQuart = new EasingFunction() {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutQuart = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    @Override
                    public float getInterpolation(float input) {
                        float position = input / 0.5f;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInSine = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float position = elapsed / (float) duration;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutSine = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float position = elapsed / (float) duration;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutSine = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float position = elapsed / (float) duration;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInExpo = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutExpo = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutExpo = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // if (elapsed == 0)
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInCirc = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float position = elapsed / (float) duration;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutCirc = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float position = elapsed / (float) duration;
            // position--;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutCirc = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // float position = elapsed / (duration / 2.f);
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInElastic = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // if (elapsed == 0)
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutElastic = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // if (elapsed == 0)
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutElastic = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // if (elapsed == 0)
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInBack = new EasingFunction()
        {
            // @Override
            // public float ease(long elapsed, long duration) {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutBack = new EasingFunction()
        {
            // @Override
            // public float ease(long elapsed, long duration) {
            // final float s = 1.70158f;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutBack = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // float s = 1.70158f;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInBounce = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseOutBounce = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
                    // float position = elapsed / (float) duration;
        ...
        public static final com.buyint.mergerbot.view.chart.animation.EasingFunction EaseInOutBounce = new
                com.buyint.mergerbot.view.chart.animation.EasingFunction() {
                    // @Override
                    // public float ease(long elapsed, long duration) {
