...
public class VoiceLineView extends View {
    ...
    private int middleLineColor = Color.WHITE;
    private int voiceLineColor = Color.WHITE;
    ...
    private void initAtts(Context context, AttributeSet attrs) {
        ...
        voiceLineColor = typedArray.getColor(R.styleable.voiceView_voiceLine, Color.WHITE);
        ...
        if (mode == RECT) {
            rectWidth = typedArray.getDimension(R.styleable.voiceView_rectWidth, 50);
        ...
        switch (BaseActivity.themeColor) {
            case 1:
                middleLineColor = 0xff232323;
                voiceLineColor = 0xff232323;
                break;
            case 2:
                middleLineColor = 0xff3986ff;
                voiceLineColor = 0xff3986ff;
                break;
            case 3:
                middleLineColor = 0xffb51818;
                voiceLineColor = 0xffb51818;
                break;
            case 4:
                middleLineColor = 0xff5a79ff;
                voiceLineColor = 0xff5a79ff;
                break;
            case 5:
                middleLineColor = 0xff2702bb;
                voiceLineColor = 0xff2702bb;
                break;
            case 6:
                middleLineColor = 0xff7345ef;
                voiceLineColor = 0xff7345ef;
                break;
        }
