...
import com.buyint.mergerbot.view.chart.components.XAxis.XAxisPosition;
...
import com.buyint.mergerbot.view.chart.data.BarEntry;
...
import com.buyint.mergerbot.view.chart.highlight.ChartHighlighter;
import com.buyint.mergerbot.view.chart.highlight.Highlight;
import com.buyint.mergerbot.view.chart.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider;
import com.buyint.mergerbot.view.chart.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import com.buyint.mergerbot.view.chart.jobs.AnimatedMoveViewJob;
import com.buyint.mergerbot.view.chart.jobs.AnimatedZoomJob;
import com.buyint.mergerbot.view.chart.jobs.MoveViewJob;
import com.buyint.mergerbot.view.chart.jobs.ZoomJob;
import com.buyint.mergerbot.view.chart.listener.BarLineChartTouchListener;
import com.buyint.mergerbot.view.chart.listener.OnDrawListener;
import com.buyint.mergerbot.view.chart.renderer.XAxisRenderer;
import com.buyint.mergerbot.view.chart.renderer.YAxisRenderer;
import com.buyint.mergerbot.view.chart.utils.PointD;
import com.buyint.mergerbot.view.chart.utils.Transformer;
import com.buyint.mergerbot.view.chart.utils.Utils;
import com.buyint.mergerbot.view.chart.charts.BarChart;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>
        extends com.buyint.mergerbot.view.chart.charts.Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    protected float[] getMarkerPosition(Entry e, Highlight highlight) {
        ...
        if (this instanceof BarChart) {
            ...
            if (this instanceof com.buyint.mergerbot.view.chart.charts.HorizontalBarChart) {
