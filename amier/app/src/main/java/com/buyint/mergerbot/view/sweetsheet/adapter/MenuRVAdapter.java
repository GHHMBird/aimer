package com.buyint.mergerbot.view.sweetsheet.adapter;
...
import com.buyint.mergerbot.view.sweetsheet.listener.SingleClickListener;
import com.buyint.mergerbot.view.sweetsheet.sweetpick.SweetSheet;
...
public class MenuRVAdapter extends RecyclerView.Adapter<MenuRVAdapter.MenuVH> {
    ...
    static class MenuVH extends RecyclerView.ViewHolder {
        ...
        public MenuVH(View itemView) {
            ...
            iv = (ImageView) itemView.findViewById(R.id.arrow);
