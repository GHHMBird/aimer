package com.buyint.mergerbot.view.floatingactionbutton;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        userButton = attr.getDrawable(R.styleable.FloatingActionsMenu_fab_addButton_icon);
...
//                mPlusColor = mAddButtonPlusColor;
            ...
            Drawable getIconDrawable() {
                final RotatingDrawable rotatingDrawable = new RotatingDrawable(null == userButton ? super.getIconDrawable() : userButton);
        ...
        mAddButton.setIconDrawable(null == userButton ? mAddButton.getIconDrawable() : userButton);
