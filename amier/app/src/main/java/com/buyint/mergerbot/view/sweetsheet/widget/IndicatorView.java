package com.buyint.mergerbot.view.sweetsheet.widget;
...
public class IndicatorView extends LinearLayout implements ViewPager.OnPageChangeListener,CircleRevealHelper.CircleRevealEnable {
    ...
    private void addIndicationView() {
        ...
        int width = getResources().getDimensionPixelSize(R.dimen.dp_12);
        int height = getResources().getDimensionPixelSize(R.dimen.dp_2);
        int padding = getResources().getDimensionPixelSize(R.dimen.dp_2);
