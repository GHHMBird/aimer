...
package com.buyint.mergerbot.view.pickerview.wheel;
...
import com.buyint.mergerbot.view.pickerview.adapters.WheelViewAdapter;
import com.buyint.mergerbot.view.pickerview.config.DefaultConfig;
import com.buyint.mergerbot.view.pickerview.config.PickerConfig;
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
    ...
    public void setConfig(PickerConfig config) {
        switch (BaseActivity.themeColor) {
            case 0:
                mPaintLineCenter.setColor(0);
                mPaintRectCenter.setColor(0);
                break;
            case 1:
                mPaintLineCenter.setColor(0xff232323);
                mPaintRectCenter.setColor(0xff232323);
                break;
            case 2:
                mPaintLineCenter.setColor(0xff3986ff);
                mPaintRectCenter.setColor(0xff3986ff);
                break;
            case 3:
                mPaintLineCenter.setColor(0xffb51818);
                mPaintRectCenter.setColor(0xffb51818);
                break;
            case 4:
                mPaintLineCenter.setColor(0xff5a79ff);
                mPaintRectCenter.setColor(0xff5a79ff);
                break;
            case 5:
                mPaintLineCenter.setColor(0xff1f0398);
                mPaintRectCenter.setColor(0xff1f0398);
                break;
            case 6:
                mPaintLineCenter.setColor(0xff7345ef);
                mPaintRectCenter.setColor(0xff7345ef);
                break;
        }
