...
public class LISessionManager {
    ...
    public void init(Activity activity,
                     Scope scope, AuthListener callback, boolean showGoToAppStoreDialog, DialogInterface.OnClickListener positive, DialogInterface.OnClickListener negaive) {
        //check if LI
        if (!LIAppVersion.isLIAppCurrent(ctx)) {
            AppStore.goAppStore(activity, showGoToAppStoreDialog,positive,  negaive);
            return;
        }
     ...
     * {@link com.linkedin.platform.LISessionManager#init(android.app.Activity, com.linkedin.platform.utils.Scope, com.linkedin.platform.listeners.AuthListener, boolean, DialogInterface.OnClickListener, DialogInterface.OnClickListener)}
     *
     * @param activity
     * @param requestCode
     * @param resultCode
